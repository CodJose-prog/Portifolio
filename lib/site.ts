export const siteConfig = {
  ...
  tagline:
    "Desenvolvedor Full Stack com experiência em liderança técnica de projetos, arquitetura SaaS multi-tenant e integração de sistemas.",
  url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://josemanoelpereira.dev",
  city: "Santarém, PA",
  country: "Brasil",
  locationLabel: "Santarém, PA - Brasil",
